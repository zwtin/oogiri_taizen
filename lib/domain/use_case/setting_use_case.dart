...
final settingUseCaseProvider =
    ChangeNotifierProvider.autoDispose.family<SettingUseCase, UniqueKey>(
  (ref, key) {
...
class SettingUseCase extends ChangeNotifier {
  SettingUseCase(
    this._key,
  ...
  void dispose() {
    super.dispose();
    _logger.d('SettingUseCase dispose $_key');
