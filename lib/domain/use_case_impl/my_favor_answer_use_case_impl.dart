...
final myFavorAnswerUseCaseProvider =
    Provider.autoDispose.family<MyFavorAnswerUseCase, UniqueKey>(
  (ref, key) {
    final myFavorAnswerUseCase = MyFavorAnswerUseCaseImpl(
      key,
    ...
    ref.onDispose(myFavorAnswerUseCase.disposed);
    return myFavorAnswerUseCase;
  },
);

class MyFavorAnswerUseCaseImpl implements MyFavorAnswerUseCase {
  MyFavorAnswerUseCaseImpl(
    this._key,
